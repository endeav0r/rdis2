...
struct _rdg_node_color * rdg_node_color_copy   (const struct _rdg_node_color *);
int                      rdg_node_color_cmp    (const struct _rdg_node_color *,
                                                const struct _rdg_node_color *);
/*
* rdg_node functions
*/
