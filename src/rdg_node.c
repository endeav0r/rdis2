...
static const struct _object rdg_node_object = {
    ...
    (void * (*) (const void *))         rdg_node_copy,
    (int    (*) (const void *, const void *)) rdg_node_cmp,
    NULL
};
...
struct _rdg_node * rdg_node_copy (const struct _rdg_node * node)
{
...
int rdg_node_cmp (const struct _rdg_node * lhs, const struct _rdg_node * rhs)
{
...
cairo_surface_t * rdg_node_draw (struct _graph_node * node)
{
    return rdg_node_draw_full(node, RDG_NODE_BG_COLOR, -1);
}
